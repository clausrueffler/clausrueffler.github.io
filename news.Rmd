...
* New preprint by *Mattias S.* and *Claus* on *bioRxiv*: [*Sex-specific dominance maintains multilocus polymorphism and can resolve sexual conflict*](https://www.biorxiv.org/content/10.64898/2026.09.09.750493v1). This article, we extend an earlier model by the same authors to a polygenic architecture.

* *Claus* presents an invited talk on coexistence of seabirds at the [*Modeling and Theory in Population Biology*](https://icerm.brown.edu/program/topical_workshop/tw-26-tpb) workshop at ICERM, Brown University, Providence, RI.  You can watch a recording of the presentation [*here*](https://icerm.brown.edu/video_archive/4686).
...
* Congratulations to *Mattias S.* for an honorable mentioning in the
[*American Naturalist Student Paper Award*](https://www.journals.uchicago.edu/doi/full/10.1086/735855#_i2) for his paper on [*anisogamy*](https://www.journals.uchicago.edu/doi/full/10.1086/727968).

* Congratulations to *Mattias F.* for successfully defending his master's thesis [*How do Arctic palsa mires affect bird abundances?*](https://uu.diva-portal.org/smash/record.jsf?pid=diva2%3A1993390&dswid=5001) After his defense, Mattias entered the world of environmental consultancy work.

* *Mattias F.* presents a poster with the results from his master's thesis at the [*Swedish Oikos Meeting*](https://nordicsocietyoikos.glueup.com/event/swedish-oikos-meeting-2025-121996/) in Stockholm.

* New paper by *Mattias S.* and *Claus* published in *eLife*: [*Heterozygote advantage can explain the extraordinary diversity of immune genes*](https://elifesciences.org/articles/94587). This article was accepted for publication via eLife's original publishing model (acceptance after peer-review).

### 2024

* New paper co-authored by *Claus* published in *PNAS*: [*Central place foragers, prey depletion halos, and how behavioral niche partitioning promotes consumer coexistence*](https://www.pnas.org/doi/10.1073/pnas.2411780121). For a press release, see [*here*](https://www.mynewsdesk.com/uu/pressreleases/new-model-can-help-understand-coexistence-in-nature-3354687) and [*here*](https://www.growkudos.com/publications/10.1073%25252Fpnas.2411780121/reader).
...
* New preprint co-authored by *Mattias* and *Claus* published on *bioRxiv*: [*Sex-specific dominance and its effects on allelic diversity in sexually antagonistic loci*](https://www.biorxiv.org/content/10.1101/2024.05.06.592709v1).
...
* New preprint by *Paula*, *Marco* and *Claus* published on *bioRxiv*: [*Consequences of life-cycle complexity to the potential for evolutionary branching*](https://www.biorxiv.org/content/10.1101/2022.08.31.506002v2).
...
* New paper co-authored by *Claus* published in *Evolution*: [*Invasion and maintenance of meiotic drivers in populations of ascomycete fungi*](https://onlinelibrary.wiley.com/doi/10.1111/evo.14214).
...
* New paper co-authored by *Claus* published: [*The components of directional and disruptive selection in heterogeneous group-structured populations*](https://www.sciencedirect.com/science/article/pii/S0022519320303040).

* New paper by *Paula* and *Claus* published in *The American Naturalist*: [*How Does Joint Evolution of Consumer Traits Affect Resource Specialization?*](https://www.journals.uchicago.edu/doi/abs/10.1086/706813?journalCode=an).
...
* New paper co-authored by *Claus* published: [*The efficacy of good genes sexual selection under environmental change*](https://royalsocietypublishing.org/doi/10.1098/rspb.2018.2313).
